...
latex_documents = [
  (master_doc, '{0}.tex', u'{1} Documentation',
   u'{1}', 'manual'),
]
'''
...
This documentation was built using IntoYunIotLibDocs_.

.. _IntoYunIotLibDocs: http://intoyuniotlibdocs.readthedocs.org
'''
...
if not os.path.exists('extras/docs'):
    ...
    os.makedirs('extras/docs/_static')
